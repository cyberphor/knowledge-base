...
Public Key Infrastructure (PKI) is a system for creating, storing, distributing, and using keys for authentication. It includes the components listed below. 
* Certificate Authority
  * Root CA: a root CA's certificate is a file they digitally signed with their own private key
  * Intermediate CA: issues certificates to fellow CAs only
  * Subordinate CA: issues certificates to users
* Registration Authority
* Private Key
* Digital Certificates: a digital certificate is a file that contains the user's public key and a digital signature generated by the CA
  * The digital signature serves as proof the CA created the certificate and that it can be trusted
  * The digital signature was generated using the CA's private key and can only be decrypted using it's public key
